...
# Endre programmet slik at vi har en tredje variabel kalt "regneoperasjon".
# Brukeren skal her skrive enten A, B, C eller D. Sjekk (if-setning) så hva brukeren har skrevet inn,
# og kall funksjonen som passer med de to tallene.
